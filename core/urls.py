...
urlpatterns = [
    ...
    path('client-correction/bulk-action/', views.client_correction_bulk_action, name='client_correction_bulk'),
    ...
    path('client-correction/<int:pk>/delete/', views.client_correction_delete, name='client_correction_delete'),
    path('knowledge/', views.knowledge_list, name='knowledge_list'),
    path('knowledge/add/', views.knowledge_create, name='knowledge_create'),
    path('knowledge/<int:pk>/edit/', views.knowledge_update, name='knowledge_update'),
